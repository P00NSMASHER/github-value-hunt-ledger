...
### Freight recovery v7 — independent audit assurance + incremental recovery proof
- Components: truth engine `DominicFinn/open_tms@93d8c2b8ff78373ff69bb7ea546743e4703628b1` + `sengtha/Kareya-Silo@a43eedea03add0728eadfc1f8ea35cc3ca6867cc` + `vidyesh95/qatoto-backend@4f5f270f6ba5ef3ed4b230716997ccea049ce408` + `hupe1980/en16931@894a3e0d36dea6d3dc086d066881d9a691b20882` + `sutasmantas/invoice-extraction-pipeline@337cac1fc43af32652683b353cb1cab3c765eb8b` + `getomni-ai/zerox@91bbb20c50de86067670aa13833afa1b8a73c22e` + confidence gate `OmarFaig/Assay@821303935ef2855908a9a9bd1efd4c33f9cd39d2` + `microsoft/RulesEngine@5650f93f843865610240e0498b26b68b477a3920` + GoldenMatch/Dedupe + `apimeister/x12-types@e8238385d9f4a8a21b6e4525f5ab3acc7bed3978` + settlement primitives `europeanplaice/subset_sum@62fe41b4c8f5d287d1904f573a9594cac254d340` and/or `Etherlabs-dev/multi-processor-reconciliation@2f9397fbe56a76abeee42a01a37536ad1811a806` + authorized live-evidence adapter `warpfreight/warp-agent-mcp@1850556032b465a0c24839e28564687462067323` + operator/UI donor `wearewarp/warp-tools@0646e7491771b7f5ddd2934fcac6e8ecb566c7fd` + optional lineage `OpenLineage/OpenLineage@e248b98e3146ff4437df76fcb07c83913d41f727` + enterprise behavior target `MicrosoftDocs/dynamics-365-unified-operations-public@b81257fa8c6f2e0599f477653b740f4565649276` + optional parcel recovery adapter `EasyPost/easypost-python@d0dd20d900e38ee954af6e6c1c4ea2aaba96cda6`.
- Combined capability: Build a customer-specific verified truth set from contract/rate authority + shipment/service evidence + invoice data; import an incumbent auditor/FAP/ERP's findings; independently rerate and classify every comparable charge; score the incumbent on dollar-weighted recall, precision, false-positive dollars, clean-invoice accuracy, rule-family recall, evidence completeness and abstention quality; then convert only unique verified misses into evidence-linked disputes and track them through credit/refund/remittance to uniquely allocated realized recovery.
- External policy validation: GSA's current 2026 Transportation Handbook explicitly says it is a best practice to **audit your auditor** and independently verify origin/destination, freight class, mileage, fuel surcharge, applicable one-time-only/contract/tender rate, accessorials, accurate weight, total billed vs total charged, signed delivery receipts, BOLs and weight tickets. The same handbook requires agencies to retain the quotation/tender/contract establishing special rates and to detect/prevent duplicate payments. This independently validates v7's acceptance-test architecture and evidence model; do not market this as GSA endorsement of our product.
- Competitive benchmark update (2026-09-01): Loop publicly launched Long-Horizon Freight AuditBench using real LTL client invoices plus signed pricing/rate packages to compare Loop's own DUX harness with general-purpose AI. It reports invoice-level % correct and cost-per-audit/correct-audit/error-caught. This means “benchmark freight-audit AI” is no longer a unique category. v7 must stay one level more neutral and customer-specific: evaluate the **customer's incumbent auditor/FAP/ERP/manual process** against a blind customer-owned truth set, quantify missed verified dollars + false-positive dollars + clean-invoice accuracy + evidence reproducibility, then prove incremental recovery through settlement attribution. Loop's publicly described benchmark does not establish that independent incumbent-vendor acceptance-testing/recovery-attribution service. Do not claim exclusivity without fresh verification.
- Why the combination is stronger: By September 2026, generic AI freight audit is table stakes: current products already advertise mixed-format invoice parsing, tariff + shipment checks, evidence packets, dispute tracking, recovery tracking and autonomous/assisted resolution. v7 therefore moves one layer up: **audit the auditor**. The durable product is an independent acceptance-test and continuous shadow-assurance system that can sit over nShift, Dynamics 365, traditional FAPs, BPO audits or internal AP/TMS controls. Every confirmed miss is incremental by construction, which makes recovery attribution and success-fee economics defensible.
- Likely buyer / user: CFO/controllers, VP Supply Chain/Transportation, freight-payment/AP leaders and procurement teams at shippers with meaningful freight spend who already have or are selecting an audit/FAP process.
- Commercial offer: Fixed-price Freight Audit Acceptance Test / vendor bake-off first; continuous shadow assurance second; optional success fee only on **incremental realized recovery** uniquely attributable to misses the incumbent did not already find.
- Build-time saved: Very high—many months across TMS, rate modeling/versioning, extraction/review, live transaction evidence, operator workflow, benchmark scoring, EDI/remittance, settlement attribution and provenance.
- Rights / license constraints: Software components are permissive as cataloged; Microsoft documentation is CC-BY-4.0. Carrier contracts/rates, auditor outputs and live customer records remain customer/provider data and require authorization. X12-derived metadata/fixtures require independent provenance. EasyPost claims/refunds are only for authorized eligible API workflows. No-license references remain clean-room only.
- Truth/benchmark requirements: Gold truth must be created independently of the incumbent result. Preserve source document/hash/page/cell/clause and calculation traces. Any unresolved extraction, contract entitlement, shipment fact, identity match or settlement allocation ambiguity yields **$0 asserted recovery**.
- Benchmark metrics: dollar-weighted recall; finding precision; false-positive dollars; clean-invoice accuracy; challenge-case accuracy; rule-family recall; evidence completeness/reproducibility; abstention quality; incremental missed dollars; realized incremental recovery.
- Recovery attribution: Exclude pre-existing claims, incumbent findings, auto-issued credits, projected savings, rejected findings and unresolved settlements. Fee base = uniquely allocated cash/credit/refund actually realized from a v7-unique validated finding.
- Validation step: One customer-authorized blind sample where incumbent findings are available. Freeze invoice/rate/shipment evidence first, create gold truth without looking at incumbent results, then compare. The first decisive KPI is **verified dollars the incumbent missed minus false-positive dollars introduced by v7**, followed by actually realized incremental recovery.
- Adapter/onboarding update: v7 now has a vendor-neutral import contract for Dynamics 365 SCM, SAP TM/S/4HANA, Oracle OTM, and generic FAP/BPO exports. Dynamics freight-bill/invoice match records become incumbent-run evidence; SAP freight settlement documents + carrier invoices/disputes become expected-vs-submitted context; Oracle payment invoices + shipments + vouchers become invoice/shipment/settlement feeds. This lowers pilot friction and reinforces that v7 measures existing systems rather than replacing their core settlement workflows.
- Status: **Highest-priority commercial strategy.** Stop treating generic invoice-vs-contract auditing as differentiation. The largest remaining blocker is one authorized customer sample containing controlling rate/accessorial truth + shipment evidence + invoices + incumbent findings/decisions for the same population.
