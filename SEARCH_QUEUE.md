...
- Do not interpret V18 `explore_swap` outcomes as worker-effect evidence unless the pair is listed as analysis-ready in `intelligence/ROUTING_EXPLORATION_PROVENANCE.md`. V19 requires complete primary generated pair provenance through dispatch, activation, claim and schema-v19 telemetry; work-steal/manual/unrouted/retrospective/incomplete-pair results are excluded.
