...
The planted matrix covers source outage versus verified emptiness, receipt-policy differences, alias/non-match/merge/split identity, same-SKU ambiguity, partial receipts, direct and service authority, rejected quantity, exact precision, non-refunding and refunding returns, vendor credits, bill cancellation, re-receipt, concurrent reverse-capacity reservation, synchronous receipts, process death after target commit, authoritative APPLIED/NOT_APPLIED/UNKNOWN, bounded replay expiry, payload conflict, zombie-worker fencing and bitemporal correction replay.
