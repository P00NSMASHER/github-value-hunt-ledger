...
- data-readiness, final pilot launch gate, deterministic launch-authorization receipt, separate-environment evidence template with SHA-256 evidence receipts/freshness semantics, and pilot protocols;
