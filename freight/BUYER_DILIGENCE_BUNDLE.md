...
- data-readiness, final pilot launch gate, actionable launch-remediation brief, separate-environment evidence template with SHA-256 evidence receipts/freshness semantics, and pilot protocols;
