...
### P0
1. **DONE:** v15 through v15.10 commercialization, proof, adaptive-authorization, commercial-learning, pilot-security, lifecycle/audit, governance/diligence, actionable launch-workflow and buyer-activation upgrades merged after CI.
2. **DONE:** canonical Freight Recovery v15.10 release identity recorded in `freight/RELEASE_MANIFEST.md`.
