...
CONTROL_PATHS = (
    ...
    "freight/carrier_action_execution.py",
    "freight/carrier_action_payload.py",
    "freight/carrier_action_workflow.py",
    ...
    "freight/counter_review_workflow.py",
    ...
    "freight/recovery_claim_workflow.py",
    ...
    "freight/site/assets/fonts/ATTRIBUTION.json",
    "freight/site/assets/fonts/LICENSE-HANKEN-GROTESK.txt",
    "freight/site/assets/fonts/LICENSE-INSTRUMENT-SERIF.txt",
    "freight/site/assets/fonts/hanken-grotesk-latin.woff2",
    "freight/site/assets/fonts/instrument-serif-italic-latin.woff2",
    "freight/site/assets/fonts/instrument-serif-latin.woff2",
    "freight/site/assets/images/approved-path-800.webp",
    "freight/site/assets/images/approved-path.webp",
    "freight/site/assets/images/dock-control-800.webp",
    "freight/site/assets/images/dock-control.webp",
    "freight/site/assets/images/freight-network-800.webp",
    "freight/site/assets/images/freight-network.webp",
    "freight/site/assets/images/human-review-800.webp",
    "freight/site/assets/images/human-review.webp",
    "freight/site/assets/images/invoice-evidence-800.webp",
    "freight/site/assets/images/invoice-evidence.webp",
    "freight/site/assets/images/rail-yard-800.webp",
    "freight/site/assets/images/rail-yard.webp",
    "freight/site/assets/images/rate-authority-800.webp",
    "freight/site/assets/images/rate-authority.webp",
    "freight/site/assets/images/terminal-blue-hour-800.webp",
    "freight/site/assets/images/terminal-blue-hour.webp",
    "freight/site/assets/images/trailer-blue-hour-800.webp",
    "freight/site/assets/images/trailer-blue-hour.webp",
    "freight/site/assets/images/truck-cab-800.webp",
    "freight/site/assets/images/truck-cab.webp",
    "freight/site/assets/images/warehouse-handoff-800.webp",
    "freight/site/assets/images/warehouse-handoff.webp",
    ...
    ".github/workflows/catalog-append.yml",
    ".github/workflows/exp008-dreamine-real-hsms.yml",
    ".github/workflows/fmc-tariff-ledger.yml",
    ".github/workflows/fmc-tariff-quality.yml",
    ...
    ".github/workflows/public-repo-hunter.yml",
    ".github/workflows/recoveryworks.yml",
    ".github/workflows/shaq-detail-probe.yml",
    ".github/workflows/shaq-mcp-sample-probe.yml",
    ".github/workflows/shaq-mcp-schema-probe.yml",
    ".github/workflows/shaq-route-archive.yml",
    ".github/workflows/shaq-route-pilot.yml",
    ".github/workflows/shaq-sitemap-probe.yml",
    ".github/workflows/technology-intelligence.yml",
    ".github/workflows/tic-mrf-ledger.yml",
    ".github/workflows/tic-targeted-extract.yml",
    ".github/workflows/urdb-ledger.yml",
)
