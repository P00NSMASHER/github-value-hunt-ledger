...
def test_manifest_allows_zero_rule_batches_for_reviewable_missing_rule_run():
    invoices = parse_invoice_charge_csv(
        filename="charges.csv",
        data=(INVOICE_HEADER + "I1,S1,C,K,USD,X1,DETENTION,2026-09-10,1,12500\n").encode(),
        buyer_id="buyer",
        business_unit="unit",
    )
    population = build_population_from_charge_batch(
