...
class ListingIntervalTests(unittest.TestCase):
    ...
    def test_real_g2_first_four_batches_expand_396_of_3828(self):
        ...
        self.assertEqual(len(result.resolved), 396)
        self.assertEqual(len(result.unresolved), 3432)
    ...
    def test_materialized_listing_metadata_matches_interval_expansion(self):
        ...
        self.assertEqual(len(actual), 396)
        expected_rows = {
            (
                item.symbol,
                item.session_date,
