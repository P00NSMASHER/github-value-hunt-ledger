...
class RealCorpusListingTests(unittest.TestCase):
    ...
    def test_verified_intervals_expand_to_complete_3828_rows(self):
        intervals = load_intervals()
        self.assertEqual(len(intervals), 146)

        result = expand_listing_intervals(
            expanded_requirements(),
            intervals,
        )
        self.assertEqual(len(result.resolved), 3828)
        ...
        self.assertEqual(exchanges["SCVL"], "NASDAQ")
        self.assertEqual(exchanges["SGEN"], "NASDAQ")
        self.assertEqual(exchanges["SKX"], "NYSE")
        self.assertEqual(exchanges["SM"], "NYSE")
        self.assertEqual(exchanges["SNDK"], "NASDAQ")
        self.assertEqual(exchanges["SNX"], "NYSE")
        self.assertEqual(exchanges["STMP"], "NASDAQ")
        self.assertEqual(exchanges["STT"], "NYSE")
        self.assertEqual(exchanges["SWKS"], "NASDAQ")
        self.assertEqual(exchanges["SYMM"], "NASDAQ")
        self.assertEqual(exchanges["TER"], "NYSE")
        self.assertEqual(exchanges["THC"], "NYSE")
        self.assertEqual(exchanges["TIBX"], "NASDAQ")
        self.assertEqual(exchanges["TNGO"], "NASDAQ")
        self.assertEqual(exchanges["TPX"], "NYSE")
        self.assertEqual(exchanges["TRAK"], "NASDAQ")
        self.assertEqual(exchanges["TW"], "NASDAQ")
        self.assertEqual(exchanges["TXRH"], "NASDAQ")
        self.assertEqual(exchanges["TXT"], "NYSE")
        self.assertEqual(exchanges["URI"], "NYSE")
        self.assertEqual(exchanges["VAR"], "NYSE")
        self.assertEqual(exchanges["VDSI"], "NASDAQ")
        self.assertEqual(exchanges["VEEV"], "NYSE")
        self.assertEqual(exchanges["VRSN"], "NASDAQ")
        self.assertEqual(exchanges["WLL"], "NYSE")
        self.assertEqual(exchanges["WMB"], "NYSE")
        self.assertEqual(exchanges["WRLD"], "NASDAQ")
        self.assertEqual(exchanges["WTS"], "NYSE")
    ...
    def test_listing_import_matches_interval_expansion_exactly(self):
        ...
        self.assertEqual(len(imported.listings), 3828)
        ...
        self.assertEqual(len(imported_rows), 3828)
    ...
    def test_manifest_tracks_restored_g2_state(self):
        ...
        self.assertEqual(manifest["listing_metadata_unresolved"], 0)
        self.assertEqual(manifest["listing_intervals_verified"], 146)
        self.assertEqual(manifest["listing_symbols_resolved"], 146)
        self.assertEqual(manifest["listing_batches_completed"], 34)
