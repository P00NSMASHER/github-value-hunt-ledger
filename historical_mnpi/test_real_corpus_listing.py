...
class RealCorpusListingTests(unittest.TestCase):
    ...
    def test_current_intervals_resolve_exactly_1430_observations(self):
        ...
        self.assertEqual(len(expansion.resolved), 1430)
        self.assertEqual(len(expansion.unresolved), 2398)
    ...
    def test_materialized_listing_metadata_matches_interval_expansion(self):
        ...
        self.assertEqual(len(materialized), 1430)
