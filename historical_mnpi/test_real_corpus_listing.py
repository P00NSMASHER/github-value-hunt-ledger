...
class RealCorpusListingTests(unittest.TestCase):
    ...
    def test_verified_intervals_expand_to_current_3740_rows(self):
        intervals = load_intervals()
        self.assertEqual(len(intervals), 142)

        result = expand_listing_intervals(
            expanded_requirements(),
            intervals,
        )
        self.assertEqual(len(result.resolved), 3740)
        self.assertEqual(len(result.unresolved), 88)
        self.assertEqual(
    ...
    def test_listing_import_matches_interval_expansion_exactly(self):
        ...
        self.assertEqual(len(imported.listings), 3740)
        ...
        self.assertEqual(len(imported_rows), 3740)
    ...
    def test_manifest_tracks_restored_g2_state(self):
        ...
        self.assertEqual(manifest["listing_metadata_resolved"], 3740)
        self.assertEqual(manifest["listing_metadata_unresolved"], 88)
        self.assertEqual(manifest["listing_intervals_verified"], 142)
        self.assertEqual(manifest["listing_symbols_resolved"], 142)
        self.assertEqual(manifest["listing_batches_completed"], 33)
