...
class RealCorpusListingTests(unittest.TestCase):
    ...
    def test_verified_intervals_expand_to_current_3036_rows(self):
        intervals = load_intervals()
        self.assertEqual(len(intervals), 112)

        result = expand_listing_intervals(
            expanded_requirements(),
            intervals,
        )
        self.assertEqual(len(result.resolved), 3036)
        self.assertEqual(len(result.unresolved), 792)
        self.assertEqual(
    ...
    def test_listing_import_matches_interval_expansion_exactly(self):
        ...
        self.assertEqual(len(imported.listings), 3036)
        ...
        self.assertEqual(len(imported_rows), 3036)
    ...
    def test_manifest_tracks_restored_g2_state(self):
        ...
        self.assertEqual(manifest["listing_metadata_resolved"], 3036)
        self.assertEqual(manifest["listing_metadata_unresolved"], 792)
        self.assertEqual(manifest["listing_intervals_verified"], 112)
        self.assertEqual(manifest["listing_symbols_resolved"], 112)
        self.assertEqual(manifest["listing_batches_completed"], 28)
