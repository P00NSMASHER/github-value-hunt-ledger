...
|---:|---|---|---|---:|---|
| 100 | COV:language-family:dotnet | Primary language family | C# / .NET | 0 / 3 | language:C# |
| 100 | COV:package-ecosystem:nuget | Package / application ecosystem | .NET / NuGet | 0 / 3 | language:C# |
| 80 | COV:language-family:c-cpp | Primary language family | C / C++ | 1 / 3 | language:C, language:C++ |
| 80 | COV:language-family:rust | Primary language family | Rust | 1 / 3 | language:Rust |
| 80 | COV:package-ecosystem:cargo | Package / application ecosystem | Rust / Cargo | 1 / 3 | language:Rust |
| 67 | COV:language-family:jvm | Primary language family | Java / Kotlin | 1 / 3 | language:Java, language:Kotlin |
| 67 | COV:package-ecosystem:maven | Package / application ecosystem | JVM / Maven / Gradle | 1 / 3 | language:Java, language:Kotlin |
| 53 | COV:package-ecosystem:odoo | Package / application ecosystem | Odoo | 1 / 3 | topic:odoo |
| 48 | COV:age-band:seven-plus | Repository age band | Created 7+ years ago | 3 / 5 | created:<=2019-09-22 |
...
| 32 | COV:star-band:ten-ninetynine | Repository attention band | 10-99 stars | 3 / 5 | stars:10..99 |
...
| 26 | COV:star-band:zero | Repository attention band | 0 stars | 4 / 5 | stars:0 |
