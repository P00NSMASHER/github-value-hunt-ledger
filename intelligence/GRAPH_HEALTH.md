...
| CAP-008 — Structured invoice compliance/validation | source_or_test_validated | 2 | 7 | 3 | 0 | 4 | official rule-pack/version authority must be pinned |
...
| CAP-019 — Source-authority observation receipts | source_or_test_validated | 2 | 4 | 10 | 3 | 4 | whole-run completeness remains source-specific; a cursor is not completeness proof. Run synthetic ERP/bank source cases where transport/auth/partial failure may never authorize VERIFIED_EMPTY or “no return.” |
...
| CAP-016 — Money-state integrity / deterministic close truth | watch | 17 | 3 | 8 | 4 | 3 | — |
