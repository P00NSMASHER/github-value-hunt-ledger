...
Allocator generation: **ALLOCGEN:34f76c214c64**
...
| SLOT-06 | experiment | 90.1 | SEED:gap:cap-012 | CAP-012 | EXP-009 | SEED:gap:cap-012 |
| SLOT-07 | coverage | 88.1 | SEED:coverage:package-ecosystem-nuget:rule-version-transfer | — | — | SEED:coverage:package-ecosystem-nuget:rule-version-transfer |
...
| SLOT-09 | coverage | 76.6 | SEED:coverage:package-ecosystem-cargo:promotion-control-transfer | — | — | SEED:coverage:package-ecosystem-cargo:promotion-control-transfer |
...
| SLOT-12 | measurement | 63.6 | SEED:measure:authority-origin-invariant-set-consistency-rule-version-transfer | — | — | SEED:measure:authority-origin-invariant-set-consistency-rule-version-transfer |
...
- Assignment ID: ASSIGN:34f76c214c64:slot-01
...
- Execution scope: READY — synthetic reference fixture PASSED; external ERP/provider adapter is the next execution.
...
- Acceptance target: all planted cases detected; unsupported recovery = 0; source outage cannot create missing-receipt/PO money; amount+quantity capacity is conserved; crash/restart cannot create a second logical counter-event; bitemporal replay reproduces known-at and valid-at truth.
...
- Assignment ID: ASSIGN:34f76c214c64:slot-02
- Work kind/action: **experiment_execution / execute_fixture**
...
- Assignment ID: ASSIGN:34f76c214c64:slot-03
- Work kind/action: **experiment_execution / execute_fixture**
...
- Assignment ID: ASSIGN:34f76c214c64:slot-04
- Work kind/action: **experiment_execution / execute_fixture**
...
- Assignment ID: ASSIGN:34f76c214c64:slot-05
...
- Assignment ID: ASSIGN:34f76c214c64:slot-06
- Work kind/action: **capability_gap / execute_fixture**
- Score: **90.08** — {"base_priority": 81.0, "experiment_boost": 8, "strategy_allocation": 1.08}
...
- Assignment ID: ASSIGN:34f76c214c64:slot-07
- Work kind/action: **coverage_gap / search**
- Score: **88.08** — {"base_priority": 87.0, "experiment_boost": 0, "strategy_allocation": 1.08}
...
- Assignment ID: ASSIGN:34f76c214c64:slot-08
- Work kind/action: **coverage_gap / search**
- Score: **77.38** — {"base_priority": 76.0, "experiment_boost": 0, "strategy_allocation": 1.38}
...
### SLOT-09 — SEED:coverage:package-ecosystem-cargo:promotion-control-transfer
- Assignment ID: ASSIGN:34f76c214c64:slot-09
- Work kind/action: **coverage_gap / search**
- Score: **76.61** — {"base_priority": 76.0, "experiment_boost": 0, "strategy_allocation": 0.61}
- Strategy/objective: STRAT:decision-claim-runtime-side-effect-trace / OBJ:runtime-side-effect
- Capability/experiment: cross-domain
- Why now: Intersect exploration blind spot COV:package-ecosystem:cargo (Rust / Cargo: 1/3) with promotion-control-transfer, an authorized anchored search hypothesis. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own sake.
- Next action: Run the bounded anchored transfer queries and inspect one connected implementation path.
...
- Assignment ID: ASSIGN:34f76c214c64:slot-10
- Work kind/action: **adjacency / search**
- Score: **101.38** — {"base_priority": 100.0, "strategy_allocation": 1.38}
...
- Assignment ID: ASSIGN:34f76c214c64:slot-11
- Work kind/action: **adjacency / search**
- Score: **101.38** — {"base_priority": 100.0, "strategy_allocation": 1.38}
- Strategy/objective: STRAT:capability-conjunction-search-claim-tracing / OBJ:emergence-triangulation
- Capability/experiment: cross-domain
...
### SLOT-12 — SEED:measure:authority-origin-invariant-set-consistency-rule-version-transfer
- Assignment ID: ASSIGN:34f76c214c64:slot-12
- Work kind/action: **strategy_measurement / search**
- Score: **63.61** — {"base_priority": 63.0, "experiment_boost": 0, "strategy_allocation": 0.61}
- Strategy/objective: STRAT:authority-origin-invariant-set-consistency / OBJ:current-rule-authority
- Capability/experiment: cross-domain
- Why now: STRAT:authority-origin-invariant-set-consistency has no measured runs but receives exploration allocation. Pair it with rule-version-transfer so the hunt searches a real gap and reduces strategy measurement debt.
- Next action: Run the bounded anchored transfer queries and inspect one connected implementation path.
- Acceptance target: One independent target-domain implementation with source/test evidence for: effective rule version, historical evaluation, authority provenance
- Queries:
...
- Assignment ID: ASSIGN:34f76c214c64:slot-13
...
- Assignment ID: ASSIGN:34f76c214c64:slot-14
