...
Allocator generation: **ALLOCGEN:083df27963a9**
...
|---|---|---:|---|---|---|---|
| SLOT-01 | experiment | 103.6 | SEED:gap:cap-013 | CAP-013 | EXP-007 | SEED:gap:cap-013 |
| SLOT-02 | experiment | 99.6 | SEED:gap:cap-007 | CAP-007 | EXP-004 | SEED:gap:cap-007 |
| SLOT-03 | experiment | 97.6 | SEED:gap:cap-002 | CAP-002 | EXP-002, EXP-003, EXP-006, EXP-009 | SEED:gap:cap-002 |
| SLOT-04 | experiment | 96.6 | SEED:gap:cap-014 | CAP-014 | EXP-008 | SEED:gap:cap-014 |
| SLOT-05 | experiment | 90.6 | SEED:gap:cap-009 | CAP-009 | — | SEED:gap:cap-009 |
| SLOT-06 | experiment | 89.6 | SEED:gap:cap-001 | CAP-001 | EXP-001, EXP-005, EXP-011 | SEED:gap:cap-001 |
| SLOT-07 | coverage | 101.6 | SEED:coverage:package-ecosystem-cargo:cap-002 | CAP-002 | EXP-002, EXP-003, EXP-006, EXP-009 | SEED:coverage:package-ecosystem-cargo:cap-002 |
| SLOT-08 | coverage | 100.6 | SEED:coverage:language-family-dotnet:cap-013 | CAP-013 | EXP-007 | SEED:coverage:language-family-dotnet:cap-013 |
| SLOT-09 | coverage | 80.6 | SEED:dna:gridappsd-cimhub | — | — | SEED:dna:gridappsd-cimhub |
| SLOT-10 | adjacency | 92.6 | ADJ:contributor-lineage:gsa-gsa-acquisition-dfars | — | — | ADJ:contributor-lineage:gsa-gsa-acquisition-dfars |
| SLOT-11 | adjacency | 91.6 | ADJ:contributor-lineage:kodekinetics79-opstrax-enterprise-build | — | — | ADJ:contributor-lineage:kodekinetics79-opstrax-enterprise-build |
| SLOT-12 | measurement | 71.6 | SEED:measure:decision-claim-runtime-side-effect-trace-cap-007 | CAP-007 | EXP-004 | SEED:measure:decision-claim-runtime-side-effect-trace-cap-007 |
| SLOT-13 | verification | 88.0 | Independent verification — SEED:gap:cap-013 | — | — | VERIFY:SEED:gap:cap-013 |
| SLOT-14 | wildcard | 75.0 | Rare / weird wildcard exploration | — | — | WILDCARD:rare-weird |

## Assignment packets

### SLOT-01 — SEED:gap:cap-013
- Assignment ID: ASSIGN:083df27963a9:slot-01
- Work kind: **capability_gap**
- Score: **103.61** — {"base_priority": 95.0, "experiment_boost": 8, "strategy_allocation": 0.61}
...
### SLOT-02 — SEED:gap:cap-007
- Assignment ID: ASSIGN:083df27963a9:slot-02
- Work kind: **capability_gap**
- Score: **99.61** — {"base_priority": 91.0, "experiment_boost": 8, "strategy_allocation": 0.61}
...
### SLOT-03 — SEED:gap:cap-002
- Assignment ID: ASSIGN:083df27963a9:slot-03
- Work kind: **capability_gap**
- Score: **97.64** — {"base_priority": 88.0, "experiment_boost": 8, "strategy_allocation": 1.64}
...
### SLOT-04 — SEED:gap:cap-014
- Assignment ID: ASSIGN:083df27963a9:slot-04
- Work kind: **capability_gap**
- Score: **96.61** — {"base_priority": 88.0, "experiment_boost": 8, "strategy_allocation": 0.61}
- Strategy/objective: STRAT:protocol-regression-archaeology-for-pre-fat-systems / OBJ:protocol-regression
...
### SLOT-05 — SEED:gap:cap-009
- Assignment ID: ASSIGN:083df27963a9:slot-05
- Work kind: **capability_gap**
- Score: **90.61** — {"base_priority": 90.0, "experiment_boost": 0, "strategy_allocation": 0.61}
...
### SLOT-06 — SEED:gap:cap-001
- Assignment ID: ASSIGN:083df27963a9:slot-06
- Work kind: **capability_gap**
- Score: **89.61** — {"base_priority": 81.0, "experiment_boost": 8, "strategy_allocation": 0.61}
- Strategy/objective: STRAT:rule-period-authority-version-audit / OBJ:authority-lineage
...
### SLOT-07 — SEED:coverage:package-ecosystem-cargo:cap-002
- Assignment ID: ASSIGN:083df27963a9:slot-07
- Work kind: **coverage_gap**
- Score: **101.64** — {"base_priority": 92.0, "experiment_boost": 8, "strategy_allocation": 1.64}
- Strategy/objective: STRAT:capability-conjunction-search-claim-tracing / OBJ:independent-evaluation
- Capability/experiment: CAP-002, EXP-002, EXP-003, EXP-006, EXP-009
...
### SLOT-08 — SEED:coverage:language-family-dotnet:cap-013
- Assignment ID: ASSIGN:083df27963a9:slot-08
- Work kind: **coverage_gap**
- Score: **100.61** — {"base_priority": 92.0, "experiment_boost": 8, "strategy_allocation": 0.61}
- Strategy/objective: STRAT:protocol-regression-archaeology-for-pre-fat-systems / OBJ:protocol-regression
- Capability/experiment: CAP-013, EXP-007
...
- Assignment ID: ASSIGN:083df27963a9:slot-09
- Work kind: **positive_dna_transfer**
- Score: **80.64** — {"base_priority": 79.0, "experiment_boost": 0, "strategy_allocation": 1.64}
...
- Assignment ID: ASSIGN:083df27963a9:slot-10
- Work kind: **adjacency**
- Score: **92.61** — {"base_priority": 92.0, "strategy_allocation": 0.61}
...
- Assignment ID: ASSIGN:083df27963a9:slot-11
- Work kind: **adjacency**
- Score: **91.61** — {"base_priority": 91.0, "strategy_allocation": 0.61}
- Strategy/objective: STRAT:paper-research-artifact-production-descendant / OBJ:research-lineage
- Capability/experiment: cross-domain
...
### SLOT-12 — SEED:measure:decision-claim-runtime-side-effect-trace-cap-007
- Assignment ID: ASSIGN:083df27963a9:slot-12
- Work kind: **strategy_measurement**
- Score: **71.61** — {"base_priority": 63.0, "experiment_boost": 8, "strategy_allocation": 0.61}
- Strategy/objective: STRAT:decision-claim-runtime-side-effect-trace / OBJ:authority-lineage
- Capability/experiment: CAP-007, EXP-004
- Why now: STRAT:decision-claim-runtime-side-effect-trace has no measured runs but receives exploration allocation. Pair it with CAP-007 so the hunt searches a real gap and reduces strategy measurement debt.
- Queries:
  - provenance evidence authority
  - provenance authority path:tests
  - provenance evidence audit replay
...
### SLOT-13 — Independent verification — SEED:gap:cap-013
- Assignment ID: ASSIGN:083df27963a9:slot-13
...
- Assignment ID: ASSIGN:083df27963a9:slot-14
- Work kind: **wildcard**
