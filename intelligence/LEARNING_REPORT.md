...
| STRAT:fail-open-boundary-archaeology | 1 | 4 | 50.0% [15.0%, 85.0%] | 0.0% [0.0%, 49.0%] | 0.0% [0.0%, 79.3%] | 100.0% [20.7%, 100.0%] | 0 | 0.00 | $0 | insufficient |
...
| QF:reachable-trusted-measurement-state-exact-work-order-line-bill-period-authority-one-use-claim-closed-mutation-surface — reachable trusted measurement state + exact work-order line + bill-period authority + one-use claim + closed mutation surface | 1 | 1 | 100.0% [20.7%, 100.0%] | 0.0% [0.0%, 79.3%] | 0.0% [0.0%, 79.3%] | 0 | 0.00 | insufficient |
| QF:recovery-coverage-identity-lifecycle-contradiction-vs-succession-vs-collision-vs-unavailable-source — recovery coverage identity lifecycle: contradiction vs succession vs collision vs unavailable source | 1 | 4 | 50.0% [15.0%, 85.0%] | 0.0% [0.0%, 49.0%] | 0.0% [0.0%, 79.3%] | 0 | 0.00 | insufficient |
| QF:recovery-proof-completeness-expected-subject-inventory-multi-engine-semantic-restore-fail-open-validation — recovery-proof completeness + expected-subject inventory + multi-engine semantic restore + fail-open validation | 1 | 4 | 50.0% [15.0%, 85.0%] | 0.0% [0.0%, 49.0%] | 0.0% [0.0%, 79.3%] | 0 | 0.00 | insufficient |
| QF:recovery-qualification-behavior-closure-currentness — recovery qualification behavior-closure currentness | 0 | 0 | — | — | — | 1 | 1.00 | insufficient |
| QF:recovery-qualification-closure-completeness-authority — recovery qualification closure completeness authority | 0 | 0 | — | — | — | 0 | 0.00 | insufficient |
| QF:recovery-qualification-skip-aware-test-inventory — recovery qualification skip aware test inventory | 0 | 0 | — | — | — | 0 | 0.00 | insufficient |
...
| QF:secs-gem-equipment-constant-atomicity-runtime-falsification — SECS/GEM equipment-constant atomicity runtime falsification | 0 | 0 | — | — | — | 1 | 1.00 | insufficient |
| QF:secs-gem-s2f15-real-hsms-atomicity-transport-validation — SECS/GEM S2F15 real-HSMS atomicity transport validation | 0 | 0 | — | — | — | 0 | 0.00 | insufficient |
| QF:status-aware-representation-invariant-current-action-receipt — status-aware-representation-invariant-current-action-receipt | 0 | 0 | — | — | — | 0 | 0.00 | insufficient |
| QF:thermo-raw-oracle-backed-parser-repair-replay — Thermo RAW oracle-backed parser repair replay | 1 | 1 | 100.0% [20.7%, 100.0%] | 0.0% [0.0%, 79.3%] | 0.0% [0.0%, 79.3%] | 0 | 0.00 | insufficient |
| QF:thermo-raw-vendor-native-versus-clean-room-decoder-field-fidelity-replay — Thermo RAW vendor-native versus clean-room decoder field-fidelity replay | 1 | 1 | 100.0% [20.7%, 100.0%] | 0.0% [0.0%, 79.3%] | 0.0% [0.0%, 79.3%] | 1 | 1.00 | insufficient |
| QF:three-jurisdiction-permit-source-truth-and-completeness — three-jurisdiction-permit-source-truth-and-completeness | 0 | 0 | — | — | — | 0 | 0.00 | insufficient |
| QF:usecpo-archive-to-member-cryptographic-binding — USECPO archive-to-member cryptographic binding | 0 | 0 | — | — | — | 0 | 0.00 | insufficient |
...
| QF:zatca-issued-artifact-authority-bundle-provenance — ZATCA issued-artifact authority-bundle provenance | 0 | 0 | — | — | — | 0 | 0.00 | insufficient |
