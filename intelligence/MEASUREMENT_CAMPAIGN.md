...
## Per-strategy next benchmark measurement
...
|---|---:|---:|---:|---:|---|---|---|---|
| STRAT:acceptance-path-transition-inspection | 0 | 10 | 4/10 | 0/0 | train_measurement | EVAL:verification-boundaries | 12 | CMP:verification-boundaries:task-12 |
| STRAT:authority-origin-invariant-set-consistency | 4 | 19 | 1/1 | 0/0 | train_measurement | EVAL:authority-currentness | 09 | CMP:authority-currentness:task-09 |
| STRAT:capability-conjunction-search-claim-tracing | 2 | 11 | 3/9 | 0/0 | train_measurement | EVAL:operational-conjunctions | 16 | CMP:operational-conjunctions:task-16 |
| STRAT:cross-source-emergence-triangulation | 5 | 20 | 0/0 | 0/0 | train_measurement | EVAL:agent-lineage-governance | 28 | CMP:agent-lineage-governance:task-28 |
| STRAT:decision-claim-runtime-side-effect-trace | 5 | 20 | 0/0 | 0/0 | train_measurement | EVAL:operational-conjunctions | 16 | CMP:operational-conjunctions:task-16 |
| STRAT:evaluation-target-independence | 1 | 14 | 4/6 | 0/0 | train_measurement | EVAL:verification-boundaries | 12 | CMP:verification-boundaries:task-12 |
| STRAT:fail-open-boundary-archaeology | 4 | 16 | 1/4 | 0/0 | train_measurement | EVAL:verification-boundaries | 12 | CMP:verification-boundaries:task-12 |
| STRAT:first-party-production-source-triangulation | 3 | 13 | 0/0 | 0/0 | train_measurement | EVAL:authority-currentness | 09 | CMP:authority-currentness:task-09 |
