...
|---|---:|---:|---:|---:|---|
| STRAT:acceptance-path-transition-inspection | 14.8% | 5 | 10 | 1.00 | insufficient |
| STRAT:capability-conjunction-search-claim-tracing | 11.6% | 2 | 6 | 0.00 | insufficient |
| STRAT:first-party-production-source-triangulation | 11.3% | 2 | 7 | 0.00 | insufficient |
| STRAT:rule-period-authority-version-audit | 9.8% | 2 | 5 | 0.00 | insufficient |
| STRAT:fail-open-boundary-archaeology | 8.9% | 1 | 4 | 0.00 | insufficient |
| STRAT:evaluation-target-independence | 8.4% | 2 | 4 | 0.00 | insufficient |
| STRAT:protocol-regression-archaeology-for-pre-fat-systems | 7.9% | 1 | 3 | 0.00 | insufficient |
| STRAT:authority-origin-invariant-set-consistency | 5.5% | 0 | 0 | 0.00 | insufficient |
| STRAT:cross-source-emergence-triangulation | 5.5% | 0 | 0 | 0.00 | insufficient |
| STRAT:decision-claim-runtime-side-effect-trace | 5.5% | 0 | 0 | 0.00 | insufficient |
| STRAT:ingestion-invariant-triad-intersection | 5.5% | 0 | 0 | 0.00 | insufficient |
| STRAT:paper-research-artifact-production-descendant | 5.5% | 0 | 0 | 0.00 | insufficient |
...
| CAP-015 — Prospective, leakage-resistant prediction and evaluator-grain evidence | 4 | 2 | first-party OEDI ZIP digest/bytes remain unresolved in the current evidence chain. Verify the current first-party artifact against the external expected digest, byte-inspect source schema/time/null semantics, then freeze the composite-event + unique-spell evaluator manifest before running policy scores. |
...
| CAP-016 — Money-state integrity / deterministic close truth | 3 | 5 | — |
| CAP-006 — Settlement-grounded recovery attribution | 2 | 1 | realized dollars require external outcome evidence |
| CAP-007 — Proof obligations, versioned proof-policy authority and typed proof admission | 2 | 2 | — |
