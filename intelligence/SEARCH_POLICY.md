...
- Measured prospective or benchmark discovery runs: **20**
- Other measured actions excluded from discovery denominators: **15**; outcome credit remains included.
...
|---|---:|---:|---:|---:|---|
| STRAT:acceptance-path-transition-inspection | 13.9% | 5 | 10 | 1.00 | insufficient |
| STRAT:capability-conjunction-search-claim-tracing | 11.5% | 3 | 9 | 1.00 | insufficient |
| STRAT:first-party-production-source-triangulation | 10.6% | 2 | 7 | 0.00 | insufficient |
| STRAT:rule-period-authority-version-audit | 9.0% | 3 | 6 | 0.00 | insufficient |
| STRAT:evaluation-target-independence | 9.0% | 4 | 6 | 3.00 | insufficient |
| STRAT:fail-open-boundary-archaeology | 8.3% | 1 | 4 | 0.00 | insufficient |
| STRAT:protocol-regression-archaeology-for-pre-fat-systems | 7.3% | 1 | 3 | 0.00 | insufficient |
| STRAT:authority-origin-invariant-set-consistency | 5.1% | 0 | 0 | 0.00 | insufficient |
| STRAT:bidirectional-money-evidence-invariant-tracing | 5.1% | 0 | 0 | 0.00 | insufficient |
| STRAT:cross-source-emergence-triangulation | 5.1% | 0 | 0 | 0.00 | insufficient |
| STRAT:decision-claim-runtime-side-effect-trace | 5.1% | 0 | 0 | 1.00 | insufficient |
...
| CAP-008 — Structured invoice compliance/validation | 4 | 2 | official rule-pack/version authority must be pinned |
...
| CAP-019 — Source-authority observation receipts | 4 | 8 | whole-run completeness remains source-specific; a cursor is not completeness proof. Run synthetic ERP/bank source cases where transport/auth/partial failure may never authorize VERIFIED_EMPTY or “no return.” |
| CAP-016 — Money-state integrity / deterministic close truth | 3 | 7 | — |
| CAP-006 — Settlement-grounded recovery attribution | 2 | 1 | realized dollars require external outcome evidence |
| CAP-007 — Proof obligations, versioned proof-policy authority and typed proof admission | 2 | 4 | — |
