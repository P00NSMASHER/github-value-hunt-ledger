...
|---:|---|---|---|---|---|
| 95 | SEED:gap:cap-013 | capability_gap | STRAT:protocol-regression-archaeology-for-pre-fat-systems | CAP-013 | CAP-013 is a current high-information gap (gap score 7, prior run attention 0). Saturation: INSUFFICIENT (+0 priority). Missing piece: vendor formats/specs and buyer fixtures separately governed. |
| 92 | SEED:coverage:language-family-dotnet:cap-009 | coverage_gap | STRAT:rule-period-authority-version-audit | CAP-009 | Intersect exploration blind spot COV:language-family:dotnet (C# / .NET: 0/3) with CAP-009, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its o |
| 92 | SEED:coverage:package-ecosystem-nuget:cap-013 | coverage_gap | STRAT:protocol-regression-archaeology-for-pre-fat-systems | CAP-013 | Intersect exploration blind spot COV:package-ecosystem:nuget (.NET / NuGet: 0/3) with CAP-013, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for i |
...
| 89 | SEED:gap:cap-007 | capability_gap | STRAT:rule-period-authority-version-audit | CAP-007 | CAP-007 is a current high-information gap (gap score 6, prior run attention 2). Saturation: INSUFFICIENT (+0 priority). Missing piece: domain policy provenance is external. |
...
| 84 | SEED:coverage:language-family-c-cpp:cap-007 | coverage_gap | STRAT:rule-period-authority-version-audit | CAP-007 | Intersect exploration blind spot COV:language-family:c-cpp (C / C++: 1/3) with CAP-007, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own  |
| 84 | SEED:coverage:language-family-rust:cap-002 | coverage_gap | STRAT:capability-conjunction-search-claim-tracing | CAP-002 | Intersect exploration blind spot COV:language-family:rust (Rust: 1/3) with CAP-002, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own sake |
| 80 | SEED:coverage:package-ecosystem-cargo:cap-008 | coverage_gap | STRAT:rule-period-authority-version-audit | CAP-008 | Intersect exploration blind spot COV:package-ecosystem:cargo (Rust / Cargo: 1/3) with CAP-008, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for i |
...
| 80 | SEED:gap:cap-012 | capability_gap | STRAT:rule-period-authority-version-audit | CAP-012 | CAP-012 is a current high-information gap (gap score 5, prior run attention 0). Saturation: INSUFFICIENT (+0 priority). Missing piece: jurisdiction completeness/semantics vary. |
...
- Why now: CAP-013 is a current high-information gap (gap score 7, prior run attention 0). Saturation: INSUFFICIENT (+0 priority). Missing piece: vendor formats/specs and buyer fixtures separately governed.
...
### SEED:coverage:language-family-dotnet:cap-009 — priority 92
- Type: coverage_gap
- Strategy: STRAT:rule-period-authority-version-audit
- Objective: OBJ:current-rule-authority
- Capability/experiment: CAP-009
- Saturation/status: INSUFFICIENT / adjustment +0 / action MEASURE_MORE
- Why now: Intersect exploration blind spot COV:language-family:dotnet (C# / .NET: 0/3) with CAP-009, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own sake.
...
### SEED:coverage:package-ecosystem-nuget:cap-013 — priority 92
- Type: coverage_gap
- Strategy: STRAT:protocol-regression-archaeology-for-pre-fat-systems
- Objective: OBJ:protocol-regression
- Capability/experiment: CAP-013, EXP-007
- Saturation/status: INSUFFICIENT / adjustment +0 / action MEASURE_MORE
- Why now: Intersect exploration blind spot COV:package-ecosystem:nuget (.NET / NuGet: 0/3) with CAP-013, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own sake.
- Required signatures: evidence, analysis, analytical-instrument, authorized, exports, fixtures, formats
- Query templates:
  - evidence analysis analytical-instrument language:C#
  - evidence analytical-instrument path:tests language:C#
- Search surfaces: GitHub repository search, GitHub code search, GitHub code search, GitHub repository search, source/tests/schema/history, author/org adjacency
- Verification gate: Retain only when at least two required signatures meet in a connected executable path and source/tests establish the claimed state transition or invariant. README-only co-location is not enough. Coverage membership alone never raises evidence quality.
- Stop conditions: Reject generic CRUD/wrapper/dashboard matches with no load-bearing invariant.; Stop after repeated capability duplicates unless a new independent implementation, stronger evidence state, or materially different failure mode appears.; If the coverage qualifier produces only shallow variants, record the no-find and do not lower the evidence bar.
- Exclude domains: none
...
### SEED:gap:cap-007 — priority 89
- Type: capability_gap
- Strategy: STRAT:rule-period-authority-version-audit
- Objective: OBJ:authority-lineage
- Capability/experiment: CAP-007, EXP-004
- Saturation/status: INSUFFICIENT / adjustment +0 / action MEASURE_MORE
- Why now: CAP-007 is a current high-information gap (gap score 6, prior run attention 2). Saturation: INSUFFICIENT (+0 priority). Missing piece: domain policy provenance is external.
...
### SEED:coverage:language-family-c-cpp:cap-007 — priority 84
- Type: coverage_gap
- Strategy: STRAT:rule-period-authority-version-audit
- Objective: OBJ:authority-lineage
- Capability/experiment: CAP-007, EXP-004
- Saturation/status: INSUFFICIENT / adjustment +0 / action MEASURE_MORE
- Why now: Intersect exploration blind spot COV:language-family:c-cpp (C / C++: 1/3) with CAP-007, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own sake.
- Required signatures: provenance, evidence, authority, blocked, whether, actually, admissibility
- Query templates:
  - provenance evidence authority language:C
  - provenance authority path:tests language:C
  - provenance evidence authority language:C++
  - provenance authority path:tests language:C++
- Search surfaces: GitHub repository search, GitHub code search, GitHub code search, GitHub repository search, source/tests/schema/history, author/org adjacency
- Verification gate: Retain only when at least two required signatures meet in a connected executable path and source/tests establish the claimed state transition or invariant. README-only co-location is not enough. Coverage membership alone never raises evidence quality.
...
### SEED:coverage:language-family-rust:cap-002 — priority 84
- Type: coverage_gap
- Strategy: STRAT:capability-conjunction-search-claim-tracing
- Objective: OBJ:independent-evaluation
- Capability/experiment: CAP-002, EXP-002, EXP-003, EXP-006, EXP-009
- Saturation/status: INSUFFICIENT / adjustment +0 / action MEASURE_MORE
- Why now: Intersect exploration blind spot COV:language-family:rust (Rust: 1/3) with CAP-002, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own sake.
- Required signatures: evidence, deterministic, replay, split, correction, judgement, merge
- Query templates:
  - evidence deterministic replay language:Rust
  - evidence replay path:tests language:Rust
- Search surfaces: GitHub repository search, GitHub code search, GitHub code search, GitHub repository search, source/tests/schema/history, author/org adjacency
- Verification gate: Retain only when at least two required signatures meet in a connected executable path and source/tests establish the claimed state transition or invariant. README-only co-location is not enough. Coverage membership alone never raises evidence quality.
- Stop conditions: Reject generic CRUD/wrapper/dashboard matches with no load-bearing invariant.; Stop after repeated capability duplicates unless a new independent implementation, stronger evidence state, or materially different failure mode appears.; If the coverage qualifier produces only shallow variants, record the no-find and do not lower the evidence bar.
- Exclude domains: none
...
### SEED:coverage:package-ecosystem-cargo:cap-008 — priority 80
- Type: coverage_gap
- Strategy: STRAT:rule-period-authority-version-audit
- Objective: OBJ:current-rule-authority
- Capability/experiment: CAP-008
- Saturation/status: INSUFFICIENT / adjustment +0 / action MEASURE_MORE
- Why now: Intersect exploration blind spot COV:package-ecosystem:cargo (Rust / Cargo: 1/3) with CAP-008, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own sake.
- Required signatures: review, semantic, authority, independent, across, disagreement, e-invoice
- Query templates:
  - review semantic authority language:Rust
  - review authority path:tests language:Rust
- Search surfaces: GitHub repository search, GitHub code search, GitHub code search, GitHub repository search, source/tests/schema/history, author/org adjacency
- Verification gate: Retain only when at least two required signatures meet in a connected executable path and source/tests establish the claimed state transition or invariant. README-only co-location is not enough. Coverage membership alone never raises evidence quality.
- Stop conditions: Reject generic CRUD/wrapper/dashboard matches with no load-bearing invariant.; Stop after repeated capability duplicates unless a new independent implementation, stronger evidence state, or materially different failure mode appears.; If the coverage qualifier produces only shallow variants, record the no-find and do not lower the evidence bar.
- Exclude domains: none
