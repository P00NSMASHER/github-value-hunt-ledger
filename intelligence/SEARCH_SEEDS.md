...
|---:|---|---|---|---|---|
| 92 | SEED:coverage:package-ecosystem-nuget:cap-009 | coverage_gap | STRAT:rule-period-authority-version-audit | CAP-009 | Intersect exploration blind spot COV:package-ecosystem:nuget (.NET / NuGet: 0/3) with CAP-009, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for i |
...
| 84 | SEED:coverage:language-family-c-cpp:cap-002 | coverage_gap | STRAT:capability-conjunction-search-claim-tracing | CAP-002 | Intersect exploration blind spot COV:language-family:c-cpp (C / C++: 1/3) with CAP-002, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own  |
| 80 | SEED:coverage:language-family-rust:cap-008 | coverage_gap | STRAT:rule-period-authority-version-audit | CAP-008 | Intersect exploration blind spot COV:language-family:rust (Rust: 1/3) with CAP-008, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own sake |
| 80 | SEED:coverage:package-ecosystem-cargo:cap-012 | coverage_gap | STRAT:rule-period-authority-version-audit | CAP-012 | Intersect exploration blind spot COV:package-ecosystem:cargo (Rust / Cargo: 1/3) with CAP-012, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for i |
...
| 76 | SEED:coverage:language-family-dotnet:cap-014 | coverage_gap | STRAT:protocol-regression-archaeology-for-pre-fat-systems | CAP-014 | Intersect exploration blind spot COV:language-family:dotnet (C# / .NET: 1/3) with CAP-014, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its o |
| 73 | SEED:gap:cap-019 | capability_gap | STRAT:fail-open-boundary-archaeology | CAP-019 | CAP-019 is a current high-information gap (gap score 4, prior run attention 1). Saturation: INSUFFICIENT (+0 priority). Missing piece: whole-run completeness remains source-specific; a cursor is not completeness proof. R |
...
### SEED:coverage:package-ecosystem-nuget:cap-009 — priority 92
- Type: coverage_gap
...
### SEED:coverage:language-family-c-cpp:cap-002 — priority 84
- Type: coverage_gap
- Strategy: STRAT:capability-conjunction-search-claim-tracing
- Objective: OBJ:independent-evaluation
- Capability/experiment: CAP-002, EXP-002, EXP-003, EXP-006, EXP-009
...
### SEED:coverage:language-family-rust:cap-008 — priority 80
- Type: coverage_gap
- Strategy: STRAT:rule-period-authority-version-audit
- Objective: OBJ:current-rule-authority
- Capability/experiment: CAP-008
- Saturation/status: INSUFFICIENT / adjustment +0 / action MEASURE_MORE
- Why now: Intersect exploration blind spot COV:language-family:rust (Rust: 1/3) with CAP-008, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own sake.
...
### SEED:coverage:package-ecosystem-cargo:cap-012 — priority 80
- Type: coverage_gap
- Strategy: STRAT:rule-period-authority-version-audit
- Objective: OBJ:completeness-proof
- Capability/experiment: CAP-012
- Saturation/status: INSUFFICIENT / adjustment +0 / action MEASURE_MORE
- Why now: Intersect exploration blind spot COV:package-ecosystem:cargo (Rust / Cargo: 1/3) with CAP-012, an active high-value capability gap. This is coverage correction tied to a valuable technical hypothesis, not diversity for its own sake.
- Required signatures: immutable, semantic, benchmark, canonicalize, completeness, detect, diffs
- Query templates:
  - immutable semantic benchmark language:Rust
  - immutable benchmark path:tests language:Rust
- Search surfaces: GitHub repository search, GitHub code search, GitHub code search, GitHub repository search, source/tests/schema/history, author/org adjacency
- Verification gate: Retain only when at least two required signatures meet in a connected executable path and source/tests establish the claimed state transition or invariant. README-only co-location is not enough. Coverage membership alone never raises evidence quality.
- Stop conditions: Reject generic CRUD/wrapper/dashboard matches with no load-bearing invariant.; Stop after repeated capability duplicates unless a new independent implementation, stronger evidence state, or materially different failure mode appears.; If the coverage qualifier produces only shallow variants, record the no-find and do not lower the evidence bar.
- Exclude domains: none
