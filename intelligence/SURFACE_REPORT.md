...
| SURFACE:local-synthetic-fixture — local synthetic fixture | SURFACE_FAMILY:synthetic-local-validation | 3 | 0 | 0 | 0.20 |
...
| SURFACE:github-code-source-tests-history — GitHub code/source/tests/history | SURFACE_FAMILY:github-history-archaeology | 1 | 4 | 3 | 0.00 |
| SURFACE:github-exact-head-code-search — GitHub exact-head code search | SURFACE_FAMILY:github-code-search | 1 | 4 | 2 | 0.00 |
| SURFACE:github-issue-archaeology — GitHub issue archaeology | SURFACE_FAMILY:github-history-archaeology | 1 | 4 | 2 | 0.00 |
| SURFACE:official-labor-law-sources — official labor-law sources | SURFACE_FAMILY:first-party-docs | 1 | 4 | 3 | 0.00 |
| SURFACE:official-payroll-engine-documentation — official Payroll Engine documentation | SURFACE_FAMILY:first-party-docs | 1 | 4 | 3 | 0.00 |
| SURFACE:private-ledger-deduplication — private ledger deduplication | SURFACE_FAMILY:private-ledger | 1 | 4 | 2 | 0.00 |
| SURFACE:repository-source-tests — repository source/tests | SURFACE_FAMILY:github-source-inspection | 1 | 4 | 2 | 0.00 |
| SURFACE:repository-source-tests-history — repository source/tests/history | SURFACE_FAMILY:github-history-archaeology | 1 | 4 | 2 | 0.00 |
...
| SURFACE:git-lfs-object-retrieval — Git LFS object retrieval | SURFACE_FAMILY:other | 1 | 2 | 2 | 0.00 |
| SURFACE:github-code-search-and-exact-revision-source-fetch — GitHub code search and exact-revision source fetch | SURFACE_FAMILY:github-code-search | 1 | 2 | 0 | 0.00 |
| SURFACE:independent-downstream-repository-comparison — independent downstream repository comparison | SURFACE_FAMILY:other | 1 | 2 | 2 | 0.00 |
| SURFACE:local-original-package-pytest-execution — local original-package pytest execution | SURFACE_FAMILY:other | 1 | 2 | 2 | 0.25 |
...
| SURFACE:official-vendor-robot-server-schema-store — official vendor robot-server schema/store | SURFACE_FAMILY:first-party-docs | 1 | 2 | 2 | 0.00 |
| SURFACE:source-faithful-synthetic-state-model — source-faithful synthetic state model | SURFACE_FAMILY:synthetic-local-validation | 1 | 2 | 2 | 0.00 |
| SURFACE:stripe-first-party-payout-documentation — Stripe first-party payout documentation | SURFACE_FAMILY:first-party-docs | 1 | 2 | 0 | 0.00 |
...
| SURFACE:real-localhost-hsms-tcp-active-passive-execution — real localhost HSMS/TCP active-passive execution | SURFACE_FAMILY:other | 1 | 1 | 1 | 0.00 |
| SURFACE:s2f13-s2f14-pre-state-and-post-state-reads — S2F13/S2F14 pre-state and post-state reads | SURFACE_FAMILY:other | 1 | 1 | 1 | 0.00 |
| SURFACE:schema-persistence-tracing — schema/persistence tracing | SURFACE_FAMILY:github-source-inspection | 1 | 1 | 1 | 0.00 |
| SURFACE:tests-and-commit-issue-archaeology — tests and commit/issue archaeology | SURFACE_FAMILY:github-history-archaeology | 1 | 1 | 1 | 0.00 |
| SURFACE:thermo-commoncore-backed-frozen-comparator-output — Thermo CommonCore-backed frozen comparator output | SURFACE_FAMILY:ecosystem-adjacency | 1 | 1 | 1 | 0.00 |
| SURFACE:upstream-original-package-pytest-regression-suite — upstream original-package pytest regression suite | SURFACE_FAMILY:other | 1 | 1 | 1 | 0.00 |
| SURFACE:zatca-official-compliance-and-enablement-toolbox-sdk-page — ZATCA official Compliance and Enablement Toolbox SDK page | SURFACE_FAMILY:other | 1 | 1 | 0 | 0.00 |
...
| SURFACE:live-san-francisco-socrata-api — live San Francisco Socrata API | SURFACE_FAMILY:other | 1 | 0 | 0 | 0.00 |
