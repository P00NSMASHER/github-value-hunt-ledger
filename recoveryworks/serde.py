...
def record_to_dict(record: LedgerRecord) -> dict[str, Any]:
    return {
        ...
        "authorized_cents": record.authorized_cents,
        "claim_action_hash": record.claim_action_hash,
        "claimed_cents": record.claimed_cents,
...
def record_from_dict(data: dict[str, Any]) -> LedgerRecord:
    return LedgerRecord(
        ...
        authorized_cents=data.get("authorized_cents", 0),
        claim_action_hash=data.get("claim_action_hash"),
        claimed_cents=data.get("claimed_cents", 0),
