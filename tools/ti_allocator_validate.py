...
caps=Counter(); exps=Counter(); strats=Counter(); roots=Counter(); kinds=Counter()
...
if kinds["coverage_gap"]<cons["min_coverage_slots"]: raise SystemExit("coverage reserve not met")
