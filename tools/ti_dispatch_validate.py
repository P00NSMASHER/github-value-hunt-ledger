...
for t in TICKETS:
    ...
    if int(p.get("claim_schema_version") or 0)<int(POL.get("minimum_claim_schema_version",14)):
        raise SystemExit(f"claim packet schema below policy minimum for {t['worker_id']}")
